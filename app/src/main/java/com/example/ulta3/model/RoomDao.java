...
public interface RoomDao {
    ...
    @Query("SELECT DISTINCT store_id FROM inventory WHERE sku = :sku")
    List<Integer> getStoresInStock(int sku);
    ...
    @Query("UPDATE product SET prob = 0 WHERE NOT (shortdesc LIKE :s OR shortdesc LIKE :s1 OR shortdesc LIKE :s2 OR longdesc LIKE :s OR longdesc LIKE :s1 OR longdesc LIKE :s2)")
    void setNonManProductsToZero(String s, String s1, String s2);
